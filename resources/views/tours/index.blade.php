...
@section('page-header')
    Giras <small>{{ trans('app.manage') }}</small>
@endsection
...
@section('content')
    ...
    <div class="mB-20">
        ...
        @can('tours.create')
        <a href="{{ route('tours.create') }}" class="btn btn-secondary">
            <i class="fa fa-plus-circle fa-fw"></i> Crear Gira
        </a>
        @endcan
        <br><br>
		<div class="row">
